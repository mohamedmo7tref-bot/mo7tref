          ...
          >
            ...
            <div className="p-8 text-center">
              ...
              <a
                ...
                className="
                group/btn flex items-center justify-center gap-3
      ...
      {selectedIndex !== null && (
        ...
        >
          ...
          <button
            ...
            className="hidden md:flex fixed right-6 top-1/2 -translate-y-1/2 cursor-pointer
            w-16 h-16 rounded-full bg-white/10 backdrop-blur-xl
            border border-white/20 text-white text-3xl
            items-center justify-center hover:bg-white/25 transition"
          >
            <FaChevronRight />
          </button>
          ...
          <button
            ...
            className="hidden md:flex fixed left-6 top-1/2 -translate-y-1/2 cursor-pointer
            w-16 h-16 rounded-full bg-white/10 backdrop-blur-xl
            border border-white/20 text-white text-3xl
            items-center justify-center hover:bg-white/25 transition"
          >
